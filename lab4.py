...
users = [
    ...
    {'login': 'john', 'password': '2005', 'name': 'Джон Доу', 'gender': 'male'},
    {'login': 'pork', 'password': '300', 'name': 'Мария Иванова', 'gender': 'female'},
]
...
def grain():
    ...
    if grain_type not in prices:
        return render_template('lab4/grain.html', error='Ошибка: не выбран тип зерна')
